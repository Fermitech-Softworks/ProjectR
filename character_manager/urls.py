...
router.register(r'characters/details', CharacterCreationViewSet, basename='characters-details')
router.register(r'characters/full', CharacterFullViewSet, basename='characters-full')
