...
router.register(r'characters/details', CharacterCreationViewSet, basename='characters')
router.register(r'characters/full', CharacterFullViewSet, basename='characters')
